...
const SuppliersGrid = ({ suppliers }: SuppliersGridProps) => {
  const handleMessageClick = (supplierId: number) => {
    console.log("Opening message with supplier:", supplierId);
    // TODO: Navigate to messages with this supplier
  };
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex space-x-2">
                      <Button 
                        variant="outline" 
                        size="sm"
                        onClick={() => handleMessageClick(supplier.id)}
                      >
